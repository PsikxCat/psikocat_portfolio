...
export default function ProjectsSliderCard({ title, imagesUrl }) {
  return (
    <>
      {/* name tag */}
      ...
      {/* content */}
      <section className='group text_shadow font-semibold flex_center absolute bottom-0 translate-y-full group-hover:-translate-y-20 lg:group-hover:-translate-y-25 transition-all duration-300 flex-center gap-x-2 text-[13px] tracking-[0.2em]'>
